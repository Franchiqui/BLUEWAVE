...
export default function GeneradorAppPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-blue-950 text-gray-100">
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            ...
            <br />
            <span className="text-gray-100">Generador de Apps</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-10">
            Crea aplicaciones completas con configuración personalizada y estructura optimizada. Ahorra tiempo y esfuerzo en el desarrollo de tus proyectos.
          </p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden border border-gray-800 shadow-2xl shadow-green-500/10 cursor-pointer" onClick={() => expandImage(IMAGES.pestanaGeneradorAppAplicacion)}>
            <PbImage
              src={IMAGES.pestanaGeneradorAppAplicacion}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              <h3 className="text-2xl font-bold text-green-400 mb-2">Generador de Apps</h3>
              <p className="text-gray-300">Crea aplicaciones completas con IA</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-green-500/50 transition-all">
              ...
              <h3 className="text-xl font-semibold text-green-400 mb-2">Asistente de IA</h3>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-green-500/50 transition-all">
              ...
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Editor de Código</h3>
