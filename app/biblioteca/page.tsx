    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-blue-950 text-gray-100">
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            ...
            <br />
            <span className="text-gray-100">Biblioteca de Aplicaciones</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-10">
            La Biblioteca es un catálogo visual de aplicaciones generadas con Zeus IA. Funciona como un marketplace/app store donde puedes explorar, probar y descargar aplicaciones listas para usar, creadas por la comunidad y por ti mismo.
          </p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden border border-gray-800 shadow-2xl shadow-green-500/10 cursor-pointer" onClick={() => expandImage(IMAGES.pestanaBiblioteca)}>
            <PbImage
              src={IMAGES.pestanaBiblioteca}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              <h3 className="text-2xl font-bold text-green-400 mb-2">Biblioteca</h3>
              <p className="text-gray-300">Ten todas tus obras a mano</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-green-500/50 transition-all">
              ...
              <h3 className="text-xl font-semibold text-green-400 mb-2">Previsualización</h3>
              <p className="text-gray-400"> Accede y utiliza tus aplicaciones en un click.</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-green-500/50 transition-all">
              ...
              <h3 className="text-xl font-semibold text-blue-400 mb-2">Almacenamiento ordenado</h3>
              <p className="text-gray-400">Ten siempre tus trabajos bien organizados.</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-green-500/50 transition-all">
              <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>
              </div>
              <h3 className="text-xl font-semibold text-purple-400 mb-2">Descarga</h3>
              <p className="text-gray-400">Cuando los necesite sabes cómo encontrarlos.</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-green-500/50 transition-all">
              <div className="w-12 h-12 bg-cyan-500/20 rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
              </div>
              <h3 className="text-xl font-semibold text-cyan-400 mb-2">Actualización</h3>
              <p className="text-gray-400">Mantén tus aplicaciones siempre actualizadas con las últimas mejoras y correcciones.</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-green-500/50 transition-all">
              ...
              <h3 className="text-xl font-semibold text-amber-400 mb-2">Planificación Inteligente</h3>
              <p className="text-gray-400">Organiza y prioriza tu trabajo de manera eficiente.</p>
            </div>
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-green-500/50 transition-all">
